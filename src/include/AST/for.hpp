...
public:
  ...
  std::unique_ptr<DeclNode> &getLoopVarDecl() { return m_loop_var_decl; }
  std::unique_ptr<AssignmentNode> &getAssign() { return m_init_stmt; }
  std::unique_ptr<ExpressionNode> &getEndCOndition() { return m_end_condition; }
  std::unique_ptr<CompoundStatementNode> &getBody() { return m_body; }
