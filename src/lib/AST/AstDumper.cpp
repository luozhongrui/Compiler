...
// FIXME: remove this line if you choose to use visitor pattern with this
// template #ifdef I_WANT_TO_USE_VISITOR_PATTERN
...
void AstDumper::visit(VariableNode &p_variable) {
  ...
  std::printf("variable <line: %u, col: %u> %s %s\n",
              ...
              p_variable.getNameCString(), p_variable.getTyeCString().c_str());
...
void AstDumper::visit(ConstantValueNode &p_constant_value) {
  ...
  std::printf("constant <line: %u, col: %u> %s\n",
              ...
              p_constant_value.getValue() /* void* */);
}
...
void AstDumper::visit(FunctionNode &p_function) {
  ...
  std::printf("function declaration <line: %u, col: %u> %s %s %s\n",
              ...
              p_function.getNameCString(), p_function.getReturnType(),
              p_function.getFunctionProToType().c_str());
